...
2. Check which are already answered by `CLAUDE.md`, the assignment, existing code, or prior specs.
...
- The six invariants in `CLAUDE.md` are addressed by name wherever the design touches them.
