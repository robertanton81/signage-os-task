...
2. Check which are already answered by the design spec, `AGENTS.md`, or codebase.
...
**Invariant:** [which AGENTS.md invariant this task upholds and which test proves it — or "none touched"]
